...
- Train Rooftop greybox: two passenger cars a coupler-length apart, with invisible walls that keep you on the roofs (`assets/models/scenarios/train_rooftop/`). The train stays still; tracks and cacti borrowed from Main Street slide past, and canyon walls and buttes drift slower on the horizon. The belt is long enough that the wrap stays out in the fog.
