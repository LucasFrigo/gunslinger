...
- [ ] Arenas are greybox CSG — not premium-shelf art. Recreate in Blender (Roadmap: Main Street / Saloon / Train Rooftop / Canyon art) before a paid listing. `from:` arenas (partial)
