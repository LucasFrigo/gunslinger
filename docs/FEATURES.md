...
| Arenas (Main Street, Saloon, Train Rooftop, Canyon) | `partial` | Placeholder CSG today (`scenarios/*/`); those layouts will be thrown out. Roadmap (one item each): Main Street / Saloon / Train Rooftop / Canyon art — new detailed greybox, then Blender meshes |
