...
Persisted under `user://`: `settings.cfg` (volume, flat window/resolution, VR/flat combat binds), `slowmo.cfg`, `movement.cfg`, `tuning.cfg`, `debug_presets.cfg`.
